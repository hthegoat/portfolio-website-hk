<template>
        ...
        <section class="text-gray-700 body-font">
            <div class="container px-8 mx-auto pt-36 lg:px-4 sm:px-0">
                <div class="flex flex-col w-full mx-auto mb-12 text-left lg:w-2/3 lg:text-center">
                    <h1 class="mb-6 text-2xl font-semibold tracking-tighter text-blue-700 sm:text-3xl title-font">
                        Let's Connect
                    </h1>
                    <p class="mx-auto text-base font-medium leading-relaxed text-gray-700 lg:w-2/3"></p>
                </div>
                <form class="flex flex-col w-full px-0 mx-auto lg:w-2/3 sm:flex-col md:px-8" action="https://getform.io/f/2a956545-1194-4d2c-bfdd-72b9b157032e" method="POST">

                    <input
                        class="flex-grow w-full px-4 py-2 mb-4 mr-4 text-base text-black transition duration-1000 ease-in-out transform rounded-lg bg-lGray focus:outline-none focus:border-purple-500 sm:mb-3 focus:bg-white focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2"
